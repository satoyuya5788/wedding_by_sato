    ...
    <div class="col-md-12">
        ...
        <form method="POST" action="{{ route('update') }}" onSubmit="return checkSubmit()">
            ...
            <div class="form-group mt-5 p-4 clearfix">
                <div class="row ">
                    <div class="col-sm-6 text-center mt-3" style="float:left;">
                        ...
                        <input class="form-control p-3" type="checkbox" name="listchart" value="1" checked="true">
                        @else
                    ...
                    <div class="col-sm-6 text-center mt-3" style="float:left;">
                        ...
                        <input class="col-xs-6" style="color:red; text-align:center; " type="number" name="present"
            ...
            <div class="form-group text-center">
                ...
                <textarea id="memo" name="memo" class="form-control shadow-lg p-3 mb-5 rounded"
                    rows="7">{{ $wedding->memo }}</textarea>
                @if ($errors->has('memo'))
            ...
            <div class="m-4">
                ...
                <button type="submit" class="btn btn-primary ml-4" style="float:right;">
                    更新する
                </button>
            </div>
            <hr>
            ...
            <div class="form-group mt-5 clearfix">
                ...
                <div class="clearfix">
                    <input disabled id="name" name="name" class="form-control shadow-lg p-3 rounded harf-input"
                        value="{{ $wedding->name }}" type="text" placeholder="(姓)">
                    <input disabled id="name_low" name="name_low"
                        class="form-control shadow-lg p-3 ml-1 round harf-input" value="{{ $wedding->name_low }}"
            ...
            <div class="form-group mt-5 clearfix">
                ...
                <div class="clearfix">
                    <input disabled id="name_kana" name="name_kana"
                        class="form-control shadow-lg p-3 rounded harf-input" value="{{ $wedding->name_kana }}"
                        type="text" placeholder="(せい)">
                    <input disabled id="name_kana_low" name="name_kana_low"
                        class="form-control shadow-lg p-3-5 ml-1 rounded harf-input"
                        value="{{ $wedding->name_kana_low }}" type="text" placeholder="(めい)">
                </div>
            ...
            <div class="form-group mt-5">
                ...
                <input disabled id="adress" name="adress" class="form-control shadow-lg p-3 mb-5 rounded"
                    value="{{ $wedding->adress }}" type="text" placeholder="都道府県　市町村　番地">
            ...
            <div class="form-group mt-5">
                ...
                <input disabled id="building" name="building" class="form-control shadow-lg p-3 mb-5 rounded"
                    value="{{ $wedding->building }}" type="text" placeholder="アパート・マンション名・その他">
            ...
            <div class="form-group mt-5 clearfix">
                ...
                <div class="clearfix">
                    <input disabled id="partner_name_one" name="partner_name_one"
                        class="form-control shadow-lg  rounded one-third-input" value="{{ $wedding->partner_name_one }}"
                        type="text" placeholder="(例)佐藤　太郎">
                    <input disabled id="partner_name_two" name="partner_name_two"
                        class="form-control shadow-lg ml-3 round one-third-input"
                        value="{{ $wedding->partner_name_two }}" type="text" placeholder="(例)佐藤　花子">
                    <input disabled id="partner_name_three" name="partner_name_three"
                        class="form-control shadow-lg ml-3 round one-third-input"
                        value="{{ $wedding->partner_name_three }}" type="text" placeholder="(例)佐藤　一郎">
                </div>
                @if ($errors->has('name'))
                <div class="text-danger">
                    {{ $errors->first('name') }}
            ...
            <div class="form-group">
                ...
                <textarea disabled id="content" name="content" class="form-control shadow-lg p-3 mb-5 rounded"
                    rows="6">{{ $wedding->content }}</textarea>
